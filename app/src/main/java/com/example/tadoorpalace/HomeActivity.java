        ...
        implements NavigationView.OnNavigationItemSelectedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView UNameTextView = headerView.findViewById(R.id.User_Name);
        CircleImageView UserDP = headerView.findViewById(R.id.User_Dp);

        UNameTextView.setText(Prevalent.currentOnlineUser.getName());

        Picasso.get().load(Prevalent.currentOnlineUser.getImage()).placeholder(R.drawable.dpicon).into(UserDP);

        recyclerView = findViewById(R.id.Menu_Recycle);
